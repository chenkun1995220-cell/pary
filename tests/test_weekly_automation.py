...
class WeeklyAutomationTests(unittest.TestCase):
    ...
    def test_orchestrator_summary_includes_universe_refresh_status(self):
        ...
        self.assertIn("sec_identity_audit.csv", script)
        self.assertIn("SEC identity conflict count", script)
        self.assertIn("SEC identity audit", script)
        self.assertIn("SEC identity audit is missing", script)
        self.assertIn("SEC identity audit is stale", script)
        self.assertIn("SEC identity audit contains unresolved conflicts", script)
        self.assertIn("configured_identity_preserved", script)
        self.assertIn("configured_cik -ne $_.selected_cik", script)
