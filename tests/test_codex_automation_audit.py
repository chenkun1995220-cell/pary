    ...
    def test_audits_three_weekly_automations_as_ready(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            write_automation(
                ...
                "automation-2",
                "港股大中盘每周筛选",
                "scripts\\run_hk_weekly.ps1 scripts\\run_self_analysis.ps1 scripts\\show_automation_check.ps1 scripts\\run_weekly_ops_check.ps1 scripts\\show_weekly_ops_history.ps1 scripts\\show_weekly_conclusion.ps1 scripts\\run_weekly_delivery_check.ps1",
                45,
            )
