...
def consistency_payload(day="2026-07-12", hk_start="2026-07-12 14:15:30"):
    starts = {
        "US": f"{day} 14:05:10",
        "CN": f"{day} 14:10:10",
        "HK": hk_start,
...
class WeeklyDeliveryStreakReviewTests(unittest.TestCase):
    def test_non_sunday_does_not_create_history_record(self):
        ...
        payload, record = build_weekly_delivery_streak_review(
            consistency_payload("2026-07-11", "2026-07-11 14:15:30"),
    ...
    def test_three_consecutive_successful_sundays_are_ready(self):
        ...
        payload, record = build_weekly_delivery_streak_review(
            consistency_payload("2026-07-26", "2026-07-26 14:16:00"),
        ...
        self.assertEqual(payload["first_hk_1415_validation_status"], "ready")
    ...
    def test_date_gap_breaks_consecutive_streak(self):
        ...
        payload, _ = build_weekly_delivery_streak_review(
            consistency_payload("2026-08-02", "2026-08-02 14:16:00"),
    ...
    def test_hk_start_outside_window_fails_current_sunday(self):
        ...
        payload, record = build_weekly_delivery_streak_review(
            consistency_payload(hk_start="2026-07-12 14:31:00"),
            delivery_payload(),
            pre_submit_payload(),
            [],
        ...
        self.assertIn("hk_run_start_outside_1415_window", record["issues"])
    ...
    def test_cli_writes_outputs_but_not_history_on_saturday(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            for name, payload in (
                ("latest_weekly_artifact_consistency.json", consistency_payload("2026-07-11", "2026-07-11 14:16:00")),
