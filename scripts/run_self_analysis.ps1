...
Write-Host "Writes: latest_self_analysis.md, latest_self_analysis_manifest.json, latest_automation_check.json, latest_manual_review_queue.csv, manual_review_queue_history.csv, manual_review_repeats.csv"
