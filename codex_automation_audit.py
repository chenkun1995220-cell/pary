...
def render_audit_report(result):
    ...
    lines.extend(
        [
            ...
            "- 港股任务必须在三市场完成后运行 run_self_analysis.ps1、show_automation_check.ps1、run_weekly_ops_check.ps1、show_weekly_ops_history.ps1、show_weekly_conclusion.ps1 和 run_weekly_delivery_check.ps1。",
        ]
    )
    return "\n".join(lines) + "\n"
