...
def render_automation_check(path):
    ...
    lines = [
        ...
        f"- forecast_next_one_week_evaluation_count={data.get('forecast_next_one_week_evaluation_count', 0)}",
        f"- forecast_next_one_month_evaluation_date={data.get('forecast_next_one_month_evaluation_date', '')}",
        f"- forecast_next_one_month_evaluation_count={data.get('forecast_next_one_month_evaluation_count', 0)}",
